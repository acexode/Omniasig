...
export class FaqComponent implements OnInit, AfterViewInit {
  ...
  faqs : Array<{ question: string, answer: string}> = [
    ...
    { 
       question : 'Care sunt datele mele de logare (user & parolă) în aplicația OMNIASIG?', 
       answer : ' Nam laoreet nunc eu molestie condimentum. Pellentesque sit amet mauris orci. Quisque sed scelerisque ipsum. Curabitur congue est sit amet felis vehicula ultrices. Curabitur dictum odio quam, ac pharetra mauris tempus a. In ornare ex urna, faucibus elementum elit fermentum non. Quisque euismod venenatis metus.',
    },
    { 
    ...
    { 
       question : 'Ce se întâmplă cu datele mele în cazul în care dezinstalez aplicația OMNIASIG?', 
       answer : 'Nam laoreet nunc eu molestie condimentum. Pellentesque sit amet mauris orci. Quisque sed scelerisque ipsum. Curabitur congue est sit amet felis vehicula ultrices. Curabitur dictum odio quam, ac pharetra mauris tempus a. In ornare ex urna, faucibus elementum elit fermentum non. Quisque euismod venenatis metus.',
    },
    { 
       question : 'Pe ce tipuri de dispozitive mobile poate fi instalată aplicația OMNIASIG?', 
       answer : ' Nam laoreet nunc eu molestie condimentum. Pellentesque sit amet mauris orci. Quisque sed scelerisque ipsum. Curabitur congue est sit amet felis vehicula ultrices. Curabitur dictum odio quam, ac pharetra mauris tempus a. In ornare ex urna, faucibus elementum elit fermentum non. Quisque euismod venenatis metus.',
    },
    { 
    ...
    { 
       question : 'Cum pot încheia o poliță de asigurare direct din aplicația OMNIASIG?', 
       answer : 'Nam laoreet nunc eu molestie condimentum. Pellentesque sit amet mauris orci. Quisque sed scelerisque ipsum. Curabitur congue est sit amet felis vehicula ultrices. Curabitur dictum odio quam, ac pharetra mauris tempus a. In ornare ex urna, faucibus elementum elit fermentum non. Quisque euismod venenatis metus.',
    },
    { 
       question : 'Pot să aflu data scadentă pentru asigurările mele direct din aplicația OMNIASIG?', 
       answer : 'Nam laoreet nunc eu molestie condimentum. Pellentesque sit amet mauris orci. Quisque sed scelerisque ipsum. Curabitur congue est sit amet felis vehicula ultrices. Curabitur dictum odio quam, ac pharetra mauris tempus a. In ornare ex urna, faucibus elementum elit fermentum non. Quisque euismod venenatis metus.',
    },
    { 
       question : 'Cum procedez în cazul în care doresc prelungirea poliței mele de asigurare?', 
       answer : 'Nam laoreet nunc eu molestie condimentum. Pellentesque sit amet mauris orci. Quisque sed scelerisque ipsum. Curabitur congue est sit amet felis vehicula ultrices. Curabitur dictum odio quam, ac pharetra mauris tempus a. In ornare ex urna, faucibus elementum elit fermentum non. Quisque euismod venenatis metus.',
    },
    { 
    ...
    { 
       question : 'Cum sunt despăgubit în cazul în care se întamplă evenimentul asigurat?', 
       answer : 'Nam laoreet nunc eu molestie condimentum. Pellentesque sit amet mauris orci. Quisque sed scelerisque ipsum. Curabitur congue est sit amet felis vehicula ultrices. Curabitur dictum odio quam, ac pharetra mauris tempus a. In ornare ex urna, faucibus elementum elit fermentum non. Quisque euismod venenatis metus.',
    },
    { 
       question : 'În cât timp voi fi despăgubit în cazul producerii unui incident?', 
       answer : 'Nam laoreet nunc eu molestie condimentum. Pellentesque sit amet mauris orci. Quisque sed scelerisque ipsum. Curabitur congue est sit amet felis vehicula ultrices. Curabitur dictum odio quam, ac pharetra mauris tempus a. In ornare ex urna, faucibus elementum elit fermentum non. Quisque euismod venenatis metus.',
    },
    { 
    ...
    { 
       question : 'Ce pași trebuie să urmez în cazul producerii unei daune în locuință?', 
       answer : 'Nam laoreet nunc eu molestie condimentum. Pellentesque sit amet mauris orci. Quisque sed scelerisque ipsum. Curabitur congue est sit amet felis vehicula ultrices. Curabitur dictum odio quam, ac pharetra mauris tempus a. In ornare ex urna, faucibus elementum elit fermentum non. Quisque euismod venenatis metus.',
    },
    { 
    ...
    { 
       question : 'Care sunt tipurile de imobil ce nu pot fi asigurate printr-o poliță Garant Amplus?', 
       answer : 'Nam laoreet nunc eu molestie condimentum. Pellentesque sit amet mauris orci. Quisque sed scelerisque ipsum. Curabitur congue est sit amet felis vehicula ultrices. Curabitur dictum odio quam, ac pharetra mauris tempus a. In ornare ex urna, faucibus elementum elit fermentum non. Quisque euismod venenatis metus.',
    },
    { 
