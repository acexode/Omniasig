...
export class OfferViewComponent implements OnInit {
  ...
  openIAB(url, type) {
    const options =
      'location=no,footer=yes,hardwareback=no,hidenavigationbuttons=yes,clearcache=yes,clearsessioncache=yes,toolbar=yes,closebuttoncaption=Close,toolbarposition=top';
