...
export class LocuinteService {
  ...
  mapToUIModel( entry: any ): Locuinte {
    return {
      ...
      paidExternalDataStartValabilitatePolita: get( entry, 'paidExternalDataStartValabilitatePolita', '' ),
      paidExternalDataStopValabilitatePolita: get( entry, 'paidExternalDataStopValabilitatePolita', '' ),
    };
  }
}
